...
class SyslogFilter(tk.Tk):
    ...
    def init_ui(self):
        ...
        priority_frame = ttk.LabelFrame(main_frame, text="Priority")
...
#        priority_control_frame.pack(side=tk.LEFT, padx=5, pady=5)
        ...
        facility_frame = ttk.LabelFrame(main_frame, text="Facility")
...
#        facility_control_frame.pack(side=tk.LEFT, padx=5, pady=5)
        ...
        entry_label = ttk.Label(custom_text_container, text="Text contains (AND=&, OR=|, NOT=~):")
...
#        ttk.Label(panel_knopok).pack(side=tk.LEFT, fill='both', expand=True)
        ...
        exit_button = ttk.Button(right, text="Cancel", command=self.quit)
    ...
    def init_priority_control_buttons(self, parent):
        ...
        select_all_cb = ttk.Checkbutton(parent, text="All", variable=select_all_var, command=lambda: self.select_all(self.priority_vars, select_all_var))
    ...
    def init_facility_control_buttons(self, parent):
        select_all_var = tk.BooleanVar()
        select_all_cb = ttk.Checkbutton(parent, text="All", variable=select_all_var, command=lambda: self.select_all(self.facility_vars, select_all_var))
        select_all_cb.pack(anchor=tk.W)
